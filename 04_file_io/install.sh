...
# Restart workflow controller to load new config
kubectl scale deployment workflow-controller --replicas=0 && kubectl scale deployment workflow-controller --replicas=1
